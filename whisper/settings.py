...
INCOMPLETE_ACCESS_REQUEST_FIRST_REMINDER_DAYS = int(os.getenv("INCOMPLETE_ACCESS_REQUEST_FIRST_REMINDER_DAYS", "4"))
INCOMPLETE_ACCESS_REQUEST_SECOND_REMINDER_DAYS = int(os.getenv("INCOMPLETE_ACCESS_REQUEST_SECOND_REMINDER_DAYS", "7"))
INCOMPLETE_ACCESS_REQUEST_PURGE_DAYS = int(os.getenv("INCOMPLETE_ACCESS_REQUEST_PURGE_DAYS", "14"))
...
LISTING_FRESHNESS_PRIVATE_STALE_DAYS = 21
LISTING_FRESHNESS_PREMARKET_STALE_DAYS = 14
LISTING_FRESHNESS_REMINDER_LEAD_DAYS = 7
