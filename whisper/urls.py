...
urlpatterns = [
    ...
    path('intake/records/', internal_views.intake_records, name='intake_records'),
    ...
    path('intake/waitlist/activate/', internal_views.intake_activate_waitlist_requests, name='intake_activate_waitlist_requests'),
    path('intake/waitlist/open-state/', internal_views.intake_open_waitlist_state, name='intake_open_waitlist_state'),
    path('intake/manual-review/process/', internal_views.intake_process_manual_review_requests, name='intake_process_manual_review_requests'),
    ...
    path('intake/request/<int:request_id>/terminate/', internal_views.intake_terminate_access, name='intake_terminate_access'),
    ...
    path('waitlist/', views.state_waitlist, name='state_waitlist'),
    path('waitlist/unsubscribe/<str:token>/', views.unsubscribe_waitlist, name='unsubscribe_waitlist'),
    ...
    path('moved-to-mls/<str:token>/', views.move_listing_to_mls_from_email, name='move_listing_to_mls_from_email'),
